...
(function() {
  ...
  Model = (function(_super) {
    ...
    Model.deleteAll = function() {
      ...
      for (key in _ref) {
        value = _ref[key];
        _results.push(this.records[key] = void 0);
      }
      return _results;
    };
    ...
    Model.prototype.destroy = function(options) {
      ...
      this.constructor.records[this.id] = void 0;
      this.constructor.crecords[this.cid] = void 0;
      this.destroyed = true;
